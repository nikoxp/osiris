...
const KEYWORD_COORDS: Record<string, [number, number]> = {
  ...
  'japan': [36.204, 138.252], 'tokyo': [35.689, 139.692], 'osaka': [34.693, 135.502], 'okinawa': [26.212, 127.681], 'hokkaido': [43.061, 141.354],
  'afghanistan': [33.939, 67.709], 'pakistan': [30.375, 69.345],
